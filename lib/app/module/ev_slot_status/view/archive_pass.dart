...
class ArchivePasspage extends StatefulWidget {
  const ArchivePasspage({super.key});

  @override
  State<ArchivePasspage> createState() => _ArchivePasspageState();
}

class _ArchivePasspageState extends State<ArchivePasspage>
    with SingleTickerProviderStateMixin {
  ParcelController parcelcontroller = Get.put(ParcelController());
  final GlobalKey<AnimatedListState> _listKey = GlobalKey<AnimatedListState>();
  final List<int> _items =
      List<int>.generate(evactivelist.length, (int index) => index);
