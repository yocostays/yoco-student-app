...
//               // Date Range Picker (only if leave == false)
// widget.leave == false
//     ? Padding(
...
// // First Date (always show if leave == true)
// widget.leave == false
//     ? Container()
//     : Padding(
//         padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
...
// // Second Date (always show if leave == true, even for single date)
// widget.leave == false
//     ? Container()
//     : Padding(
//         padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
...
//             ? "0"
//             : _leavecontroller.selectedDay.length == 1
//                 ? "0" // single date
//                 : _leavecontroller.totaldate.text, // date range
//         style: Theme.of(context).textTheme.bodyLarge?.copyWith(
