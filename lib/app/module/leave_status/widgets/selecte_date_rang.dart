...
class SelecteDateRange extends StatelessWidget {
  final bool leave;
  const SelecteDateRange({
    super.key,
      ...
      children: [
        ...
        Row(
          ...
          children: [
            SizedBox(
              width: leave == true
                  ? MediaQuery.of(context).size.width * 0.57.w
              ...
              child: InkWell(
                ...
                child: Ev_Slot_Custom_textfield(
                  ...
                  TextController: leave == true
                      ? _leavecontroller.selectDaterang
