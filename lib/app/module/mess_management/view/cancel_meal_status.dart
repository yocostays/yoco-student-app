...
class CancelMealStatus extends StatefulWidget {
  const CancelMealStatus({super.key});

  @override
  State<CancelMealStatus> createState() => _CancelMealStatusState();
}

class _CancelMealStatusState extends State<CancelMealStatus> {
  ...
  void initState() {
    super.initState();
    messController.GetCancleedMealList();
  }
                ...
                SizedBox(
                  ...
                  child: Obx(
                    () => Padding(
                        ...
                        child: messController.CencelHistoryLoading.value == true
                            ? ListView.builder(
                                shrinkWrap: true,
                                itemCount: 10,
                            ...
                            : messController.CancelHistorydata.isEmpty
                                ? Center(
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 250),
                                      child: Text(
                                        "There no Canceled Meal Data.",
                                ...
                                : ListView.builder(
                                    itemCount:
                                        messController.CancelHistorydata.length,
                                    // messController
                                    //     .CancelHistorydata.length,
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      String title = "";

                                      if (messController
                                              .CancelHistorydata[index]
                                              .breakfast ==
                                          false) {
                                        title += "Breakfast";
                                      }
                                            ...
                                            children: [
                                              MessTicketCard(
                                                ...
                                                time: Utils.formatTimePass(
                                                    DateTime.parse(messController
                                                            .CancelHistorydata[
                                                                index]
                                                            .date ??
                                                        "2024-10-07T00:00:00.000Z")),
                                                date: Utils.formatSelectedDateYear(
                                                    DateTime.parse(messController
                                                            .CancelHistorydata[
                                                                index]
                                                            .date ??
